...
public class Menu {
    ...
    private DataExtractor<ArrayList<?>> dataExtractor;
    private MenuPrinter printer;

    public Menu(ArrayList<MenuEntry> menuEntries, MenuView menuView, DataExtractor<ArrayList<?>> dataExtractor, MenuPrinter printer) {
